...
public enum CustomExceptionType {
    ...
    // BOARD EXCEPTION
    BOARD_NOT_FOUND(HttpStatus.BAD_REQUEST, "E006", "존재하지 않는 게시물입니다"),
    ALREADY_DELETED_BOARD(HttpStatus.BAD_REQUEST, "E007", "이미 삭제된 게시물입니다"),
    NO_AUTHORITY_TO_UPDATE(HttpStatus.FORBIDDEN, "E008", "게시물 수정 권한이 존재하지 않습니다");
