...
const Boardtabs = [
  { key: BoardType.FREE, label: '자유게시판', path: '/Board/free', writePath: '/Board/free/record' },
  { key: BoardType.WORKOUT, label: '운동게시판', path: '/Board/workout', writePath: '/Board/workout/record' },
